    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="d-flex justify-content-end mb-3">
                <g:form class="d-flex align-items-center gap-2" action="list" controller="user" method="get">
                    <g:link class="btn btn-primary text-nowrap" action="create"><i class="fa fa-pencil"></i> <g:message code="default.new.label" args="[entityName]" /></g:link>
